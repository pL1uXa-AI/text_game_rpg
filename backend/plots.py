...
def _theme_from_plot(pid: str, plot: dict, group: str = "user") -> dict:
    ...
    return {
        ...
        "genre": genre,
        "desc": goal,
        "style": ("Пиши живо и атмосферно, строго в русле этого сюжета: держи канон мира "
                   "(не противоречь ЛОРУ мира и фактам сюжета), плавно раскрывай завязку и веди "
                   "к глобальной цели по канве актов/квестов, не решая за игрока."
